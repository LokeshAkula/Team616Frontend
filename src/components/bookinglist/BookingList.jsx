        ...
        <>
            {
                ...
                <Box className={classes.component}>
                    <Box className={classes.leftComponent}>
                        ...
                        <Box className={classes.header} style={{fontWeight:600,fontSize:18}}>
                            My WishList ({bookingListItems.length})
                        </Box>
                ...
                <Box style={{textAlign:'center',paddingTop:70,margin:'80px 140px'}}>
                    <Typography style={{fontSize:20,fontWeight:'bolder'}}>Your WishList is Empty</Typography>
                    <Typography>Add Bookings to it now</Typography>
                    <Button onClick={()=>addBooking()} style={{background:'#4054b4',color:'white',padding:'12px 70px',marginTop:20}}>Book Now</Button>
                </Box>
